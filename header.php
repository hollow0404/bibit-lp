...
<html lang="ja">
  <head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-185675150-2"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
      gtag('config', 'UA-185675150-2');
    </script>
    ...
    })(window,document,'script','dataLayer','GTM-M7FW986');</script>
  ...
  <body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-M7FW986"
